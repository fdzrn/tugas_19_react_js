			...
			<Divider horizontal> Masukan Data </Divider>
		      ...
		      <Form.Group>
		        <Form.Input
		          ...
		          width={6}
		          value={this.state.form.nama_karyawan}
		        />
		        <Form.Input
		          placeholder='Jabatan'
		          name='jabatan'
		        ...
		        />
		         <Form.Input
		          ...
		          onChange ={this.handleFormChange}
		          width={6}
		          value={this.state.form.jenis_kelamin}
		        />
		         <Form.Input
		          ...
		          onChange ={this.handleFormChange}
		          width={6}
		          value={this.state.form.tanggal_lahir}
		        />
		        <Form.Button content='Save' primary onClick={this.handleSave}/>
		      </Form.Group>
		    </Form>
		    <Divider horizontal>Data yang telah tersimpan</Divider>
		  {
				this.state.worker.map(worker => {
				return <Karyawan key={worker.id} data={worker} delete={this.handleRemove} update={this.handleUpdate} />
				})
			}	
	    </Fragment>
		)
